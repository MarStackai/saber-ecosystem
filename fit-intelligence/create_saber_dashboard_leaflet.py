#!/usr/bin/env python3
"""
Create a beautiful Saber-branded dashboard with Leaflet (no API key required)
"""
...
def create_saber_dashboard():
    """Create a beautiful Saber-branded dashboard using Leaflet"""
...
def main():
    logger.info("Creating Saber-branded Leaflet dashboard...")
    ...
    # Save dashboard
    with open('visualizations/saber_dashboard_leaflet.html', 'w') as f:
        f.write(dashboard_html)
    
    print("\n" + "="*60)
    print("SABER LEAFLET DASHBOARD CREATED")
    print("="*60)
    print("\n🎨 Features:")
    print("   ✓ No API key required - uses OpenStreetMap")
    print("   ✓ Saber brand colors and styling")
    print("   ✓ Tailwind CSS for beautiful UI")
    print("   ✓ Leaflet with clustering and heatmap")
    ...
    print("\n📁 Dashboard: visualizations/saber_dashboard_leaflet.html")
    print("\nTo view: open visualizations/saber_dashboard_leaflet.html")
    
    # Try to open automatically
    import webbrowser
    import os
    full_path = os.path.abspath('visualizations/saber_dashboard_leaflet.html')
